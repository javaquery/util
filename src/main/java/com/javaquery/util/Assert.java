...
public final class Assert {
   ...
   *     {@code null}
   */
  public static <T extends Throwable> void nonNull(Object object, Supplier<T> exceptionSupplier)
      throws T {
   ...
   */
  public static <T extends Throwable> void isNull(Object object, Supplier<T> exceptionSupplier)
      throws T {
   ...
   *     exceptionSupplier} is {@code null}
   */
  public static <T extends Throwable> void isTrue(boolean expression, Supplier<T> exceptionSupplier)
      throws T {
    if (!expression) {
      throw exceptionSupplier.get();
    }
   ...
   *     exceptionSupplier} is {@code null}
   */
  public static <T extends Throwable> void isFalse(
      boolean expression, Supplier<T> exceptionSupplier) throws T {
    if (expression) {
      throw exceptionSupplier.get();
    }
  }
   ...
   *     exceptionSupplier} is {@code null}
   */
  public static <T extends Throwable> void nonNullNonEmpty(
      Collection<?> collection, Supplier<T> exceptionSupplier) throws T {
   ...
   */
  public static <T extends Throwable> void nullOrEmpty(
      Collection<?> collection, Supplier<T> exceptionSupplier) throws T {
   ...
   *     exceptionSupplier} is {@code null}
   */
  public static <T extends Throwable> void nonNullNonEmptyMap(
      Map<?, ?> map, Supplier<T> exceptionSupplier) throws T {
   ...
   */
  public static <T extends Throwable> void nullOrEmptyMap(
      Map<?, ?> map, Supplier<T> exceptionSupplier) throws T {
