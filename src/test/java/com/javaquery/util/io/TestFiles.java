...
public class TestFiles {
    ...
    public void test_writeToFile_2() {
        ...
        Assertions.assertThrows(NullPointerException.class, () -> Files.writeToFile(new File(getTemporaryFilePath()), null));
    }
    ...
    public void test_appendToFile_3() {
        Assertions.assertThrows(NullPointerException.class, () -> Files.appendToFile(null, TEMP_DATA, false));
        Assertions.assertThrows(NullPointerException.class, () -> Files.appendToFile(new File(getTemporaryFilePath()), null, false));
    }
    ...
    private String getTemporaryFilePath() {
        return TMP_DIR + File.separatorChar + "javaquery" + File.separatorChar + "javaquery_" + UUID.randomUUID().toString() + ".txt";
    }
}
